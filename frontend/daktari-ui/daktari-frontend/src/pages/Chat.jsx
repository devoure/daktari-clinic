...
const Chat = () => {
  ...
  let [navSliderChat, setNavSliderChat] = useState(false)
  let [editProfileChat, setProfileEditChat] = useState(false)
  let navSliderBtn = useRef()

  function slideNavBar(e){
    navSliderBtn.current.classList.toggle("clicked")
    setNavSliderChat((prev)=>{
      return(
        !prev
      )
    })
  ...
  return (
    <main className="dashboard">
      ...
      <section className={`content-section ${navSliderChat ? "nav-toggle" : ""}`}>
        ...
        <div className="content-body chat">

          <div className={`profile-edit ${editProfileChat ? "active-profile-edit": ""}`}>
